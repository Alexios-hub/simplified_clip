...
def convert_model(gpt2_model, new_cfg):
    """
    Convert the decoder blocks in a gpt2 model to our customisable myTransformerBlock.
    """
    new_blocks = []
    for i, _ in enumerate(gpt2_model.transformer.h):
        new_block = myTransformerBlock(new_cfg, layer_idx=i)
...
class myTransformerBlock(nn.Module):
    ...
    def __init__(self, config, layer_idx=None):
        ...
        self.attn = myMHAttention(config, layer_idx=layer_idx)
