...
class ShapedAttention(nn.Module):
    def __init__(self, d_model, h, dropout=None, batch_first=False):
        super().__init__()
    ...
    def forward(self, q, k, v, mask=None):
        ...
        query, key, value = self.w_q(q), self.w_k(k), v
        ...
        x, self.attention_scores = ShapedAttention.attention(query, key, value, mask, self.dropout)
        ...
        return x
class ShapedAttentionBlock(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None):
        super().__init__()
        
        self.attn = ShapedAttention(d_model, n_head)
